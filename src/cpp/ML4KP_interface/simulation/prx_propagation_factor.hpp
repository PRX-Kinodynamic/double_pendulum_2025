...
class prx_propagation_factor_t : public gtsam::NoiseModelFactorN<X, X, Xdot, Types...>
{
  using Base = gtsam::NoiseModelFactorN<X, X, Xdot, Types...>;
  using Derived = prx_propagation_factor_t<X, Xdot, Types...>;
...
public:
  ...
  // prx_propagation_factor_t(const Keys... keys, const NoiseModel& cost_model, const double h,
